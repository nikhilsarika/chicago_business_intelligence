...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=vibrant-victory-346914:us-central1:mypostgres sslmode=disable port = 5432"
